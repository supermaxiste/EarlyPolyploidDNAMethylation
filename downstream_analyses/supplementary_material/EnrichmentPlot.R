...
HM_RS7_G1_1_hal <- read.delim("masked/HM_RS7K_G1_1_hal_dataframe_rcmeth.txt")
HM_RS7_G1_2_hal <- read.delim("masked/HM_RS7K_G1_2_hal_dataframe_rcmeth.txt")
HM_RS7_G1_3_hal <- read.delim("masked/HM_RS7K_G1_3_hal_dataframe_rcmeth.txt")

HM_RS7_G4_1_hal <- fread("masked/HM_RS7_G4_1_hal_dataframe_rcmeth.txt")
HM_RS7_G4_2_hal <- fread("masked/HM_RS7_G4_2_hal_dataframe_rcmeth.txt")
HM_RS7_G4_3_hal <- fread("masked/HM_RS7_G4_3_hal_dataframe_rcmeth.txt")
...
LL_RS7_G1_1_hal <- read.delim("masked/LL_RS7_G1_1_hal_dataframe_rcmeth.txt")
LL_RS7_G1_2_hal <- read.delim("masked/LL_RS7_G1_2_hal_dataframe_rcmeth.txt")
LL_RS7_G1_3_hal <- read.delim("masked/LL_RS7_G1_3_hal_dataframe_rcmeth.txt")

LL_RS7_G4_1_hal <- fread("masked/LL_RS7K_G4_1_hal_dataframe_rcmeth.txt")
LL_RS7_G4_2_hal <- fread("masked/LL_RS7K_G4_2_hal_dataframe_rcmeth.txt")
LL_RS7_G4_3_hal <- fread("masked/LL_RS7K_G4_3_hal_dataframe_rcmeth.txt")
...
HM_RS7_G1_1_lyr <- read.delim("masked/HM_RS7K_G1_1_lyr_dataframe_rcmeth.txt")
HM_RS7_G1_2_lyr <- read.delim("masked/HM_RS7K_G1_2_lyr_dataframe_rcmeth.txt")
HM_RS7_G1_3_lyr <- read.delim("masked/HM_RS7K_G1_3_lyr_dataframe_rcmeth.txt")

HM_RS7_G4_1_lyr <- fread("masked/HM_RS7_G4_1_lyr_dataframe_rcmeth.txt")
HM_RS7_G4_2_lyr <- fread("masked/HM_RS7_G4_2_lyr_dataframe_rcmeth.txt")
HM_RS7_G4_3_lyr <- fread("masked/HM_RS7_G4_3_lyr_dataframe_rcmeth.txt")
...
LL_RS7_G1_1_lyr <- read.delim("masked/LL_RS7_G1_1_lyr_dataframe_rcmeth.txt")
LL_RS7_G1_2_lyr <- read.delim("masked/LL_RS7_G1_2_lyr_dataframe_rcmeth.txt")
LL_RS7_G1_3_lyr <- read.delim("masked/LL_RS7_G1_3_lyr_dataframe_rcmeth.txt")

LL_RS7_G4_1_lyr <- fread("masked/LL_RS7K_G4_1_lyr_dataframe_rcmeth.txt")
LL_RS7_G4_2_lyr <- fread("masked/LL_RS7K_G4_2_lyr_dataframe_rcmeth.txt")
LL_RS7_G4_3_lyr <- fread("masked/LL_RS7K_G4_3_lyr_dataframe_rcmeth.txt")
...
### Filter out average methylations beyond +- 500bp and adjust distance
### value within gene bodies to fit synthetic dataframe

new_dist <- c(rep(-100, 3),
              rep(-200, 3),
              rep(-300, 3),
              rep(-400, 3),
              rep(-500, 3),
...
filter_fit <- function(df){
  new_df <- filter(df, where == "inside" | distance == -100 |
           distance == -200 | distance == -300 | distance == -400 |
           distance == -500 | distance == 2000 | distance == 2100 | 
           distance == 2200 | distance == 2300 | distance == 2400)
  new_df$distance <- new_dist
  return(new_df)
}

### halleri side

HM_hal_G1_1 <- filter_fit(HM_hal_G1_1)
HM_hal_G1_2 <- filter_fit(HM_hal_G1_2)
HM_hal_G1_3 <- filter_fit(HM_hal_G1_3)

HM_hal_G4_1 <- filter_fit(HM_hal_G4_1)
HM_hal_G4_2 <- filter_fit(HM_hal_G4_2)
HM_hal_G4_3 <- filter_fit(HM_hal_G4_3)

HM_ALK_G1_1_hal <- filter_fit(HM_ALK_G1_1_hal)
HM_ALK_G1_2_hal <- filter_fit(HM_ALK_G1_2_hal)
HM_ALK_G1_3_hal <- filter_fit(HM_ALK_G1_3_hal)

HM_ALK_G4_1_hal <- filter_fit(HM_ALK_G4_1_hal)
HM_ALK_G4_2_hal <- filter_fit(HM_ALK_G4_2_hal)
HM_ALK_G4_3_hal <- filter_fit(HM_ALK_G4_3_hal)

HM_TKS_G1_1_hal <- filter_fit(HM_TKS_G1_1_hal)
HM_TKS_G1_2_hal <- filter_fit(HM_TKS_G1_2_hal)
HM_TKS_G1_3_hal <- filter_fit(HM_TKS_G1_3_hal)

HM_TKS_G5_1_hal <- filter_fit(HM_TKS_G5_1_hal)
HM_TKS_G5_2_hal <- filter_fit(HM_TKS_G5_2_hal)
HM_TKS_G5_3_hal <- filter_fit(HM_TKS_G5_3_hal)

LL_hal_G1_1 <- filter_fit(LL_hal_G1_1)
LL_hal_G1_2 <- filter_fit(LL_hal_G1_2)
LL_hal_G1_3 <- filter_fit(LL_hal_G1_3)

LL_hal_G4_1 <- filter_fit(LL_hal_G4_1)
LL_hal_G4_2 <- filter_fit(LL_hal_G4_2)

LL_ALK_G1_1_hal <- filter_fit(LL_ALK_G1_1_hal)
LL_ALK_G1_2_hal <- filter_fit(LL_ALK_G1_2_hal)
LL_ALK_G1_3_hal <- filter_fit(LL_ALK_G1_3_hal)

LL_ALK_G4_1_hal <- filter_fit(LL_ALK_G4_1_hal)
LL_ALK_G4_2_hal <- filter_fit(LL_ALK_G4_2_hal)
LL_ALK_G4_3_hal <- filter_fit(LL_ALK_G4_3_hal)

LL_TKS_G1_1_hal <- filter_fit(LL_TKS_G1_1_hal)
LL_TKS_G1_2_hal <- filter_fit(LL_TKS_G1_2_hal)
LL_TKS_G1_3_hal <- filter_fit(LL_TKS_G1_3_hal)

LL_TKS_G5_1_hal <- filter_fit(LL_TKS_G5_1_hal)
LL_TKS_G5_2_hal <- filter_fit(LL_TKS_G5_2_hal)
LL_TKS_G5_3_hal <- filter_fit(LL_TKS_G5_3_hal)

### lyrata side

HM_lyr_G1_1 <- filter_fit(HM_lyr_G1_1)
HM_lyr_G1_2 <- filter_fit(HM_lyr_G1_2)
HM_lyr_G1_3 <- filter_fit(HM_lyr_G1_3)

HM_lyr_G4_1 <- filter_fit(HM_lyr_G4_1)
HM_lyr_G4_2 <- filter_fit(HM_lyr_G4_2)
HM_lyr_G4_3 <- filter_fit(HM_lyr_G4_3)

HM_ALK_G1_1_lyr <- filter_fit(HM_ALK_G1_1_lyr)
HM_ALK_G1_2_lyr <- filter_fit(HM_ALK_G1_2_lyr)
HM_ALK_G1_3_lyr <- filter_fit(HM_ALK_G1_3_lyr)

HM_ALK_G4_1_lyr <- filter_fit(HM_ALK_G4_1_lyr)
HM_ALK_G4_2_lyr <- filter_fit(HM_ALK_G4_2_lyr)
HM_ALK_G4_3_lyr <- filter_fit(HM_ALK_G4_3_lyr)

HM_TKS_G1_1_lyr <- filter_fit(HM_TKS_G1_1_lyr)
HM_TKS_G1_2_lyr <- filter_fit(HM_TKS_G1_2_lyr)
HM_TKS_G1_3_lyr <- filter_fit(HM_TKS_G1_3_lyr)

HM_TKS_G5_1_lyr <- filter_fit(HM_TKS_G5_1_lyr)
HM_TKS_G5_2_lyr <- filter_fit(HM_TKS_G5_2_lyr)
HM_TKS_G5_3_lyr <- filter_fit(HM_TKS_G5_3_lyr)

LL_lyr_G1_1 <- filter_fit(LL_lyr_G1_1)
LL_lyr_G1_2 <- filter_fit(LL_lyr_G1_2)
LL_lyr_G1_3 <- filter_fit(LL_lyr_G1_3)

LL_lyr_G4_1 <- filter_fit(LL_lyr_G4_1)
LL_lyr_G4_2 <- filter_fit(LL_lyr_G4_2)

LL_ALK_G1_1_lyr <- filter_fit(LL_ALK_G1_1_lyr)
LL_ALK_G1_2_lyr <- filter_fit(LL_ALK_G1_2_lyr)
LL_ALK_G1_3_lyr <- filter_fit(LL_ALK_G1_3_lyr)

LL_ALK_G4_1_lyr <- filter_fit(LL_ALK_G4_1_lyr)
LL_ALK_G4_2_lyr <- filter_fit(LL_ALK_G4_2_lyr)
LL_ALK_G4_3_lyr <- filter_fit(LL_ALK_G4_3_lyr)

LL_TKS_G1_1_lyr <- filter_fit(LL_TKS_G1_1_lyr)
LL_TKS_G1_2_lyr <- filter_fit(LL_TKS_G1_2_lyr)
LL_TKS_G1_3_lyr <- filter_fit(LL_TKS_G1_3_lyr)

LL_TKS_G5_1_lyr <- filter_fit(LL_TKS_G5_1_lyr)
LL_TKS_G5_2_lyr <- filter_fit(LL_TKS_G5_2_lyr)
LL_TKS_G5_3_lyr <- filter_fit(LL_TKS_G5_3_lyr)
...
# plot the missing Cs
# 
# CG_hal_all <- rbind(HM_hal_G1_1[HM_hal_G1_1$category=="missing" & HM_hal_G1_1$context=="CG",],
#                     HM_hal_G1_2[HM_hal_G1_2$category=="missing" & HM_hal_G1_2$context=="CG",],
#                     HM_hal_G1_3[HM_hal_G1_3$category=="missing" & HM_hal_G1_3$context=="CG",],
#                     HM_RS7K_G1_1_hal[HM_RS7K_G1_1_hal$category=="missing" & HM_RS7K_G1_1_hal$context=="CG",],
#                     HM_RS7K_G1_2_hal[HM_RS7K_G1_2_hal$category=="missing" & HM_RS7K_G1_2_hal$context=="CG",],
#                     HM_RS7K_G1_3_hal[HM_RS7K_G1_3_hal$category=="missing" & HM_RS7K_G1_3_hal$context=="CG",],
#                     HM_RS7_G4_1_hal[HM_RS7_G4_1_hal$category=="missing" & HM_RS7_G4_1_hal$context=="CG",],
#                     HM_RS7_G4_2_hal[HM_RS7_G4_2_hal$category=="missing" & HM_RS7_G4_2_hal$context=="CG",],
#                     HM_RS7_G4_3_hal[HM_RS7_G4_3_hal$category=="missing" & HM_RS7_G4_3_hal$context=="CG",],
#                     HM_ALK_G4_1_hal[HM_ALK_G4_1_hal$category=="missing" & HM_ALK_G4_1_hal$context=="CG",],
#                     HM_ALK_G4_2_hal[HM_ALK_G4_2_hal$category=="missing" & HM_ALK_G4_2_hal$context=="CG",],
#                     HM_ALK_G4_3_hal[HM_ALK_G4_3_hal$category=="missing" & HM_ALK_G4_3_hal$context=="CG",])
# 
# CHG_hal_all <- rbind(HM_hal_G1_1[HM_hal_G1_1$category=="missing" & HM_hal_G1_1$context=="CHG",],
#                      HM_hal_G1_2[HM_hal_G1_2$category=="missing" & HM_hal_G1_2$context=="CHG",],
#                      HM_hal_G1_3[HM_hal_G1_3$category=="missing" & HM_hal_G1_3$context=="CHG",],
#                      HM_RS7K_G1_1_hal[HM_RS7K_G1_1_hal$category=="missing" & HM_RS7K_G1_1_hal$context=="CHG",],
#                      HM_RS7K_G1_2_hal[HM_RS7K_G1_2_hal$category=="missing" & HM_RS7K_G1_2_hal$context=="CHG",],
#                      HM_RS7K_G1_3_hal[HM_RS7K_G1_3_hal$category=="missing" & HM_RS7K_G1_3_hal$context=="CHG",],
#                      HM_RS7_G4_1_hal[HM_RS7_G4_1_hal$category=="missing" & HM_RS7_G4_1_hal$context=="CHG",],
#                      HM_RS7_G4_2_hal[HM_RS7_G4_2_hal$category=="missing" & HM_RS7_G4_2_hal$context=="CHG",],
#                      HM_RS7_G4_3_hal[HM_RS7_G4_3_hal$category=="missing" & HM_RS7_G4_3_hal$context=="CHG",],
#                      HM_ALK_G4_1_hal[HM_ALK_G4_1_hal$category=="missing" & HM_ALK_G4_1_hal$context=="CHG",],
#                      HM_ALK_G4_2_hal[HM_ALK_G4_2_hal$category=="missing" & HM_ALK_G4_2_hal$context=="CHG",],
#                      HM_ALK_G4_3_hal[HM_ALK_G4_3_hal$category=="missing" & HM_ALK_G4_3_hal$context=="CHG",])
# 
# CHH_hal_all <- rbind(HM_hal_G1_1[HM_hal_G1_1$category=="missing" & HM_hal_G1_1$context=="CHH",],
#                      HM_hal_G1_2[HM_hal_G1_2$category=="missing" & HM_hal_G1_2$context=="CHH",],
#                      HM_hal_G1_3[HM_hal_G1_3$category=="missing" & HM_hal_G1_3$context=="CHH",],
#                      HM_RS7K_G1_1_hal[HM_RS7K_G1_1_hal$category=="missing" & HM_RS7K_G1_1_hal$context=="CHH",],
#                      HM_RS7K_G1_2_hal[HM_RS7K_G1_2_hal$category=="missing" & HM_RS7K_G1_2_hal$context=="CHH",],
#                      HM_RS7K_G1_3_hal[HM_RS7K_G1_3_hal$category=="missing" & HM_RS7K_G1_3_hal$context=="CHH",],
#                      HM_RS7_G4_1_hal[HM_RS7_G4_1_hal$category=="missing" & HM_RS7_G4_1_hal$context=="CHH",],
#                      HM_RS7_G4_2_hal[HM_RS7_G4_2_hal$category=="missing" & HM_RS7_G4_2_hal$context=="CHH",],
#                      HM_RS7_G4_3_hal[HM_RS7_G4_3_hal$category=="missing" & HM_RS7_G4_3_hal$context=="CHH",],
#                      HM_ALK_G4_1_hal[HM_ALK_G4_1_hal$category=="missing" & HM_ALK_G4_1_hal$context=="CHH",],
#                      HM_ALK_G4_2_hal[HM_ALK_G4_2_hal$category=="missing" & HM_ALK_G4_2_hal$context=="CHH",],
#                      HM_ALK_G4_3_hal[HM_ALK_G4_3_hal$category=="missing" & HM_ALK_G4_3_hal$context=="CHH",])
# 
# CG_lyr_all <- rbind(HM_lyr_G1_1[HM_lyr_G1_1$category=="missing" & HM_lyr_G1_1$context=="CG",],
#                     HM_lyr_G1_2[HM_lyr_G1_2$category=="missing" & HM_lyr_G1_2$context=="CG",],
#                     HM_lyr_G1_3[HM_lyr_G1_3$category=="missing" & HM_lyr_G1_3$context=="CG",],
#                     HM_RS7K_G1_1_lyr[HM_RS7K_G1_1_lyr$category=="missing" & HM_RS7K_G1_1_lyr$context=="CG",],
#                     HM_RS7K_G1_2_lyr[HM_RS7K_G1_2_lyr$category=="missing" & HM_RS7K_G1_2_lyr$context=="CG",],
#                     HM_RS7K_G1_3_lyr[HM_RS7K_G1_3_lyr$category=="missing" & HM_RS7K_G1_3_lyr$context=="CG",],
#                     HM_RS7_G4_1_lyr[HM_RS7_G4_1_lyr$category=="missing" & HM_RS7_G4_1_lyr$context=="CG",],
#                     HM_RS7_G4_2_lyr[HM_RS7_G4_2_lyr$category=="missing" & HM_RS7_G4_2_lyr$context=="CG",],
#                     HM_RS7_G4_3_lyr[HM_RS7_G4_3_lyr$category=="missing" & HM_RS7_G4_3_lyr$context=="CG",],
#                     HM_ALK_G4_1_lyr[HM_ALK_G4_1_lyr$category=="missing" & HM_ALK_G4_1_lyr$context=="CG",],
#                     HM_ALK_G4_2_lyr[HM_ALK_G4_2_lyr$category=="missing" & HM_ALK_G4_2_lyr$context=="CG",],
#                     HM_ALK_G4_3_lyr[HM_ALK_G4_3_lyr$category=="missing" & HM_ALK_G4_3_lyr$context=="CG",])
# 
# CHG_lyr_all <- rbind(HM_lyr_G1_1[HM_lyr_G1_1$category=="missing" & HM_lyr_G1_1$context=="CHG",],
#                      HM_lyr_G1_2[HM_lyr_G1_2$category=="missing" & HM_lyr_G1_2$context=="CHG",],
#                      HM_lyr_G1_3[HM_lyr_G1_3$category=="missing" & HM_lyr_G1_3$context=="CHG",],
#                      HM_RS7K_G1_1_lyr[HM_RS7K_G1_1_lyr$category=="missing" & HM_RS7K_G1_1_lyr$context=="CHG",],
#                      HM_RS7K_G1_2_lyr[HM_RS7K_G1_2_lyr$category=="missing" & HM_RS7K_G1_2_lyr$context=="CHG",],
#                      HM_RS7K_G1_3_lyr[HM_RS7K_G1_3_lyr$category=="missing" & HM_RS7K_G1_3_lyr$context=="CHG",],
#                      HM_RS7_G4_1_lyr[HM_RS7_G4_1_lyr$category=="missing" & HM_RS7_G4_1_lyr$context=="CHG",],
#                      HM_RS7_G4_2_lyr[HM_RS7_G4_2_lyr$category=="missing" & HM_RS7_G4_2_lyr$context=="CHG",],
#                      HM_RS7_G4_3_lyr[HM_RS7_G4_3_lyr$category=="missing" & HM_RS7_G4_3_lyr$context=="CHG",],
#                      HM_ALK_G4_1_lyr[HM_ALK_G4_1_lyr$category=="missing" & HM_ALK_G4_1_lyr$context=="CHG",],
#                      HM_ALK_G4_2_lyr[HM_ALK_G4_2_lyr$category=="missing" & HM_ALK_G4_2_lyr$context=="CHG",],
#                      HM_ALK_G4_3_lyr[HM_ALK_G4_3_lyr$category=="missing" & HM_ALK_G4_3_lyr$context=="CHG",])
# 
# CHH_lyr_all <- rbind(HM_lyr_G1_1[HM_lyr_G1_1$category=="missing" & HM_lyr_G1_1$context=="CHH",],
#                      HM_lyr_G1_2[HM_lyr_G1_2$category=="missing" & HM_lyr_G1_2$context=="CHH",],
#                      HM_lyr_G1_3[HM_lyr_G1_3$category=="missing" & HM_lyr_G1_3$context=="CHH",],
#                      HM_RS7K_G1_1_lyr[HM_RS7K_G1_1_lyr$category=="missing" & HM_RS7K_G1_1_lyr$context=="CHH",],
#                      HM_RS7K_G1_2_lyr[HM_RS7K_G1_2_lyr$category=="missing" & HM_RS7K_G1_2_lyr$context=="CHH",],
#                      HM_RS7K_G1_3_lyr[HM_RS7K_G1_3_lyr$category=="missing" & HM_RS7K_G1_3_lyr$context=="CHH",],
#                      HM_RS7_G4_1_lyr[HM_RS7_G4_1_lyr$category=="missing" & HM_RS7_G4_1_lyr$context=="CHH",],
#                      HM_RS7_G4_2_lyr[HM_RS7_G4_2_lyr$category=="missing" & HM_RS7_G4_2_lyr$context=="CHH",],
#                      HM_RS7_G4_3_lyr[HM_RS7_G4_3_lyr$category=="missing" & HM_RS7_G4_3_lyr$context=="CHH",],
#                      HM_ALK_G4_1_lyr[HM_ALK_G4_1_lyr$category=="missing" & HM_ALK_G4_1_lyr$context=="CHH",],
#                      HM_ALK_G4_2_lyr[HM_ALK_G4_2_lyr$category=="missing" & HM_ALK_G4_2_lyr$context=="CHH",],
#                      HM_ALK_G4_3_lyr[HM_ALK_G4_3_lyr$category=="missing" & HM_ALK_G4_3_lyr$context=="CHH",])
...
## We split the whole dataframe in 2
## Dataframe 1: diploids and synthetics

HM_CG_hal_1 <- filter(HM_CG_hal, species == "halleri" |
                        species == "kamchatica-syn")
HM_CHG_hal_1 <- filter(HM_CHG_hal, species == "halleri" |
                        species == "kamchatica-syn")
HM_CHH_hal_1 <- filter(HM_CHH_hal, species == "halleri" |
                        species == "kamchatica-syn")

HM_CG_lyr_1 <- filter(HM_CG_lyr, species == "lyrata" |
                        species == "kamchatica-syn")
HM_CHG_lyr_1 <- filter(HM_CHG_lyr, species == "lyrata" |
                         species == "kamchatica-syn")
HM_CHH_lyr_1 <- filter(HM_CHH_lyr, species == "lyrata" |
                         species == "kamchatica-syn")

LL_CG_hal_1 <- filter(LL_CG_hal, species == "halleri" |
                        species == "kamchatica-syn")
LL_CHG_hal_1 <- filter(LL_CHG_hal, species == "halleri" |
                         species == "kamchatica-syn")
LL_CHH_hal_1 <- filter(LL_CHH_hal, species == "halleri" |
                         species == "kamchatica-syn")

LL_CG_lyr_1 <- filter(LL_CG_lyr, species == "lyrata" |
                        species == "kamchatica-syn")
LL_CHG_lyr_1 <- filter(LL_CHG_lyr, species == "lyrata" |
                         species == "kamchatica-syn")
LL_CHH_lyr_1 <- filter(LL_CHH_lyr, species == "lyrata" |
                         species == "kamchatica-syn")


## Dataframe 2: synthetics and naturals


HM_CG_hal_2 <- filter(HM_CG_hal, species == "kamchatica-syn" |
                        species == "kamchatica-natural-alk" | 
                        species == "kamchatica-natural-tks")
HM_CHG_hal_2 <- filter(HM_CHG_hal, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")
HM_CHH_hal_2 <- filter(HM_CHH_hal, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")

HM_CG_lyr_2 <- filter(HM_CG_lyr, species == "kamchatica-syn" |
                        species == "kamchatica-natural-alk" | 
                        species == "kamchatica-natural-tks")
HM_CHG_lyr_2 <- filter(HM_CHG_lyr, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")
HM_CHH_lyr_2 <- filter(HM_CHH_lyr, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")

LL_CG_hal_2 <- filter(LL_CG_hal, species == "kamchatica-syn" |
                        species == "kamchatica-natural-alk" | 
                        species == "kamchatica-natural-tks")
LL_CHG_hal_2 <- filter(LL_CHG_hal, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")
LL_CHH_hal_2 <- filter(LL_CHH_hal, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")

LL_CG_lyr_2 <- filter(LL_CG_lyr, species == "kamchatica-syn" |
                        species == "kamchatica-natural-alk" | 
                        species == "kamchatica-natural-tks")
LL_CHG_lyr_2 <- filter(LL_CHG_lyr, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")
LL_CHH_lyr_2 <- filter(LL_CHH_lyr, species == "kamchatica-syn" |
                         species == "kamchatica-natural-alk" | 
                         species == "kamchatica-natural-tks")
...
ggplt1 <- ggplt1 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "halleri.G1" = colours[1], "halleri.G4" = colours[2]))
ggplt1 <- ggplt1 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt1 <- ggplt1 + scale_y_continuous(limits=c(0.25,0.65))
...
ggplt1 <- ggplt1 + ggtitle(expression(paste("Cold conditions ",italic("\nhalleri-side"))))
ggplt1
...
ggplt2 <- ggplt2 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "halleri.G1" = colours[1], "halleri.G4" = colours[2]))
ggplt2 <- ggplt2 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt2 <- ggplt2 + scale_y_continuous(limits=c(0.10,0.28))
...
ggplt3 <- ggplt3 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "halleri.G1" = colours[1], "halleri.G4" = colours[2]))
ggplt3 <- ggplt3 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt3 <- ggplt3 + scale_y_continuous(limits=c(0.05,0.15))
...
ggplt4 <- ggplt4 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "lyrata.G1" = colours[5], "lyrata.G4" = colours[6]))
ggplt4 <- ggplt4 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt4 <- ggplt4 + scale_y_continuous(limits=c(0.25,0.65))
...
ggplt5 <- ggplt5 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "lyrata.G1" = colours[5], "lyrata.G4" = colours[6]))
ggplt5 <- ggplt5 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt5 <- ggplt5 + scale_y_continuous(limits=c(0.10,0.28))
...
ggplt6 <- ggplt6 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], "kamchatica-syn.G4" = colours[4], "lyrata.G1" = colours[5], "lyrata.G4" = colours[6]))
ggplt6 <- ggplt6 + scale_x_continuous(breaks=breaks, labels=labels)
ggplt6 <- ggplt6 + scale_y_continuous(limits=c(0.05,0.15))
...
### All enrichment profiles together for HM conditions
...
### METHimpute plotting function for synthetics vs naturals
...
ggplt1 <- ggplot(df1, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt1 <- ggplt1 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
...
ggplt2 <- ggplot(df2, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt2 <- ggplt2 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
                                                 "kamchatica-natural-tks.G1" = colours[9],
...
ggplt3 <- ggplot(df3, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt3 <- ggplt3 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
                                                 "kamchatica-natural-tks.G1" = colours[9],
...
ggplt4 <- ggplot(df4, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt4 <- ggplt4 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
                                                 "kamchatica-natural-tks.G1" = colours[9],
...
ggplt5 <- ggplot(df5, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt5 <- ggplt5 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
                                                 "kamchatica-natural-tks.G1" = colours[9],
...
ggplt6 <- ggplot(df6, aes(x = distance, y = mean, group = interaction(species, generation), col = interaction(species, generation))) + geom_line(lwd = 1.5)
ggplt6 <- ggplt6 + scale_color_manual(values = c("kamchatica-syn.G1" = colours[3], 
                                                 "kamchatica-syn.G4" = colours[4], 
                                                 "kamchatica-natural-alk.G1" = colours[7], 
                                                 "kamchatica-natural-alk.G4" = colours[8],
                                                 "kamchatica-natural-tks.G1" = colours[9],
