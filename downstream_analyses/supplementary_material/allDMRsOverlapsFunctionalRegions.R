...
DMRs_overlap <- function(hal_CG_all,
  ...
  ### Import data: annotations with 2kb flanking regions marked as genes and DMRs
  
  ### Paths to annotation files to be modified according to new system!!!!
  
  Ahal_v2_2_2kb_promoters <- read.delim("~/OneDrive/PhD/Project/bs_data/Ahal_genome/Ahal_v2_2_500bp_promoters.gff",
                                        header=FALSE,
                                        col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                      "strand", "dot", "extra"))
  Alyr_v2_2_renamed_2kb_promoters <- read.delim("~/OneDrive/PhD/Project/bs_data/Alyr_genome/Alyr_v2_2_500bp_promoters.gff", 
                                                header=FALSE,
                                                col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                              "strand", "dot", "extra"))
  
  Ahal_anno <- select(Ahal_v2_2_2kb_promoters, scaffold, context, start, end, strand)
  rm(Ahal_v2_2_2kb_promoters)
  
  
  Alyr_anno <- select(Alyr_v2_2_renamed_2kb_promoters, scaffold, context, start, end, strand)
  rm(Alyr_v2_2_renamed_2kb_promoters)
  ...
  Ahal_v2_2 <- read.delim("~/OneDrive/PhD/Project/bs_data/Ahal_genome/Ahal_v2_2.gff", header=FALSE,
                          col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                        "strand", "dot", "extra"))
  ...
  Alyr_v2_2_renamed <- read.delim("~/OneDrive/PhD/Project/bs_data/Alyr_genome/Alyr_v2_2_renamed.gff", header=FALSE,
                                  col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                "strand", "dot", "extra"))
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vpro1_HM/dmrseq")
dmrseq_output_CG_hal <- fread("CG_context/parent1_v_allo.txt")
dmrseq_output_CHG_hal <- fread("CHG_context/parent1_v_allo.txt")
dmrseq_output_CHH_hal <- fread("CHH_context/parent1_v_allo.txt")
dmrseq_output_CG_lyr <- fread("CG_context/parent2_v_allo.txt")
...
HM_nat4_v_pro1 <-DMRs_overlap(hal_CG_all = dmrseq_output_CG_hal,
             hal_CHG_all = dmrseq_output_CHG_hal,
             hal_CHH_all = dmrseq_output_CHH_hal,
             lyr_CG_all = dmrseq_output_CG_lyr,
             lyr_CHG_all = dmrseq_output_CHG_lyr,
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vsyn1_HM/dmrseq")
...
HM_nat4_v_syn1 <- DMRs_overlap_special(dmrseq_output_CG_AvB = dmrseq_output_CG_AvB,
                     dmrseq_output_CHG_AvB = dmrseq_output_CHG_AvB,
                     dmrseq_output_CHH_AvB = dmrseq_output_CHH_AvB,
                     extract_legend = F)

## Import data

setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vsyn4_HM/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
HM_nat4_v_syn4 <- DMRs_overlap_special(dmrseq_output_CG_AvB = dmrseq_output_CG_AvB,
                                       dmrseq_output_CHG_AvB = dmrseq_output_CHG_AvB,
                                       dmrseq_output_CHH_AvB = dmrseq_output_CHH_AvB,
                                       extract_legend = F)
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vpro1_HM/dmrseq")
dmrseq_output_CG_hal <- fread("CG_context/parent1_v_allo.txt")
dmrseq_output_CHG_hal <- fread("CHG_context/parent1_v_allo.txt")
dmrseq_output_CHH_hal <- fread("CHH_context/parent1_v_allo.txt")
dmrseq_output_CG_lyr <- fread("CG_context/parent2_v_allo.txt")
...
HM_tks1_v_pro1 <-DMRs_overlap(hal_CG_all = dmrseq_output_CG_hal,
                              hal_CHG_all = dmrseq_output_CHG_hal,
                              hal_CHH_all = dmrseq_output_CHH_hal,
                              lyr_CG_all = dmrseq_output_CG_lyr,
                              lyr_CHG_all = dmrseq_output_CHG_lyr,
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vsyn1_HM/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
HM_tks1_v_syn1 <- DMRs_overlap_special(dmrseq_output_CG_AvB = dmrseq_output_CG_AvB,
                                       dmrseq_output_CHG_AvB = dmrseq_output_CHG_AvB,
                                       dmrseq_output_CHH_AvB = dmrseq_output_CHH_AvB,
                                       extract_legend = F)
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vsyn4_HM/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
HM_tks1_v_syn4 <- DMRs_overlap_special(dmrseq_output_CG_AvB = dmrseq_output_CG_AvB,
                                       dmrseq_output_CHG_AvB = dmrseq_output_CHG_AvB,
                                       dmrseq_output_CHH_AvB = dmrseq_output_CHH_AvB,
                                       extract_legend = F)

legendAll <- DMRs_overlap_special(dmrseq_output_CG_AvB = dmrseq_output_CG_AvB,
                                  dmrseq_output_CHG_AvB = dmrseq_output_CHG_AvB,
                                  dmrseq_output_CHH_AvB = dmrseq_output_CHH_AvB,
                                  extract_legend = T)
...
#  (wrap_elements(grid::textGrob('ALK1 vs PRO1')) + HM_nat4_v_pro1 + plot_layout(widths = c(0.1, 1))) / 
#  (wrap_elements(grid::textGrob('ALK1 vs SYN1')) + HM_nat4_v_syn1 + plot_layout(widths = c(0.1, 1))) / 
#  (wrap_elements(grid::textGrob('ALK1 vs SYN4')) + HM_nat4_v_syn4 + plot_layout(widths = c(0.1, 1))) /
#(wrap_elements(grid::textGrob('TKS1 vs PRO1')) + HM_tks1_v_pro1 + plot_layout(widths = c(0.1, 1))) / 
#  (wrap_elements(grid::textGrob('TKS1 vs SYN1')) + HM_tks1_v_syn1 + plot_layout(widths = c(0.1, 1))) / 
#  (wrap_elements(grid::textGrob('TKS1 vs SYN4')) + HM_tks1_v_syn4 + plot_layout(widths = c(0.1, 1))) /
#  (wrap_elements(legendAll + plot_layout(widths = c(0.1, 1)))) 
