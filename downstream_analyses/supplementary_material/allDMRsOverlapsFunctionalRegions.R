...
DMRs_overlap <- function(hal_CG_all,
  ...
  Ahal_v2_2_2kb_promoters <- read.delim("Ahal_v2_2_500bp_promoters.gff",
                                        header=FALSE,
                                        col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                      "strand", "dot", "extra"))
  Alyr_v2_2_renamed_2kb_promoters <- read.delim("Alyr_v2_2_500bp_promoters.gff",
                                                header=FALSE,
                                                col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                              "strand", "dot", "extra"))
  ...
  Ahal_v2_2 <- read.delim("Ahal_v2_2.gff", header=FALSE,
                          col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                        "strand", "dot", "extra"))
  ...
  Alyr_v2_2_renamed <- read.delim("Alyr_v2_2_renamed.gff", header=FALSE,
                                  col.names = c("scaffold", "tool", "context", "start", "end", "number",
                                                "strand", "dot", "extra"))
