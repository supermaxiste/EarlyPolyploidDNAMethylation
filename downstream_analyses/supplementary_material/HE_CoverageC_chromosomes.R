...
hal_totC_dens <- read.delim("~/OneDrive/PhD/Project/Chapter_3/coverage_analysis/00_data/hal_totC_dens.txt")
lyr_totC_dens <- read.delim("~/OneDrive/PhD/Project/Chapter_3/coverage_analysis/00_data/lyr_totC_dens.txt")
...
HM_RS7K_G1_hal <- HM_RS7K_G1_1_hal_dens
HM_RS7K_G1_hal$coverage <- HM_RS7K_G1_hal_avg_coverage

HM_RS7K_G1_lyr <- HM_RS7K_G1_1_lyr_dens
HM_RS7K_G1_lyr$coverage <- HM_RS7K_G1_lyr_avg_coverage
...
HM_RS7_G4_hal_old <- HM_RS7_G4_1_hal_dens
HM_RS7_G4_hal_old$coverage <- HM_RS7_G4_hal_avg_coverage_old

HM_RS7_G4_lyr_old <- HM_RS7_G4_1_lyr_dens
HM_RS7_G4_lyr_old$coverage <- HM_RS7_G4_lyr_avg_coverage_old
...
HM_RS7K_G1_hal <- mutate(HM_RS7K_G1_hal, sample = "HM_RS7K_G1_hal")
HM_RS7_G4_hal <- mutate(HM_RS7_G4_hal, sample = "HM_RS7_G4_hal")
HM_RS7_G4_hal_old <- mutate(HM_RS7_G4_hal_old, sample = "HM_RS7_G4_hal_old")
...
HM_RS7K_G1_lyr <- mutate(HM_RS7K_G1_lyr, sample = "HM_RS7K_G1_lyr")
HM_RS7_G4_lyr <- mutate(HM_RS7_G4_lyr, sample = "HM_RS7_G4_lyr")
HM_RS7_G4_lyr_old <- mutate(HM_RS7_G4_lyr_old, sample = "HM_RS7_G4_lyr_old")
...
homeo_HM_lyr_G <- GRanges(seqnames = homeo_HM_lyr$seqnames,
                          ranges = IRanges(start = homeo_HM_lyr$start,
                                           end = homeo_HM_lyr$end))
...
homeo_LL_lyr_G <- GRanges(seqnames = homeo_LL_lyr$seqnames,
...
nonhomeo_HM_overlap_continuous <- data.frame(start_scaffold = c("scaffold_1_RagTag",
                                                                "scaffold_1_RagTag",
                                                                "scaffold_6_RagTag",
                                                                "scaffold_8_RagTag"),
                                             start_coordinate = c(5000000,
                                                                  15000000,
                                                                  7500000,
                                                                  2500000),
                                             end_coordinate = c(10000000,
                                                                20000000,
                                                                15000000,
                                                                12500000))

nonhomeo_LL_overlap_continuous <- data.frame(start_scaffold = c("scaffold_6_RagTag",
                                                                "scaffold_8_RagTag"),
...
HM_both_chr1 <- ggplot() +
  geom_rect(data = nonhomeo_HM_overlap_continuous %>% filter(start_scaffold == "scaffold_1_RagTag"), aes(xmin = start_coordinate/1e5, xmax = end_coordinate/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "chartreuse4") +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_1_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[1]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_1_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[1]), y = coverage, color = sample)) +
  xlab("Chromosome 1") +
  theme_linedraw() +
...
HM_both_chr2 <- ggplot() +
  geom_rect(data = homeo_HM_hal_overlap_continuous %>% filter(seqnames == "scaffold_2_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "brown4") +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_2_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[2]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_2_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[2]), y = coverage, color = sample)) +
  xlab("Chromosome 2") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr3 <- ggplot() +
  geom_rect(data = homeo_HM_hal_overlap_continuous %>% filter(seqnames == "scaffold_3_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "brown4") +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_3_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[3]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_3_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[3]), y = coverage, color = sample)) +
  xlab("Chromosome 3") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr4 <- ggplot() +
  geom_rect(data = homeo_HM_hal_overlap_continuous %>% filter(seqnames == "scaffold_4_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "brown4") +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_4_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[4]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_4_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[4]), y = coverage, color = sample)) +
  xlab("Chromosome 4") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr5 <- ggplot() +
  #geom_rect(data = homeo_HM_hal_overlap_continuous %>% filter(seqnames == "scaffold_5_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5) +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_5_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[5]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_5_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[5]), y = coverage, color = sample)) +
  xlab("Chromosome 5") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr6 <- ggplot() +
  geom_rect(data = nonhomeo_HM_overlap_continuous %>% filter(start_scaffold == "scaffold_6_RagTag"), aes(xmin = start_coordinate/1e5, xmax = end_coordinate/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "chartreuse4") +
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_6_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[6]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_6_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[6]), y = coverage, color = sample)) +
  xlab("Chromosome 6") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr7 <- ggplot() +
  ...
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_7_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[7]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_7_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[7]), y = coverage, color = sample)) +
  xlab("Chromosome 7") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
HM_both_chr8 <- ggplot() +
  ...
  geom_line(data = all_hal %>% filter(seqnames == "scaffold_8_RagTag", sample == "HM_RS7_G4_hal"), aes(x = c(1:chrom_length_hal[8]), y = coverage, color = sample)) +
  geom_line(data = all_lyr %>% filter(seqnames == "scaffold_8_RagTag", sample == "HM_RS7_G4_lyr"), aes(x = c(1:chrom_length_lyr[8]), y = coverage, color = sample)) +
  xlab("Chromosome 8") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr1 <- ggplot() +
  geom_rect(data = homeo_LL_hal_overlap_continuous %>% filter(seqnames == "scaffold_1_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "brown4") +
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_1_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[1]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_1_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[1]), y = coverage, color = sample)) +
  xlab("Chromosome 1") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr2 <- ggplot() +
  geom_rect(data = homeo_LL_hal_overlap_continuous %>% filter(seqnames == "scaffold_2_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "brown4") +
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_2_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[2]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_2_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[2]), y = coverage, color = sample)) +
  xlab("Chromosome 2") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr3 <- ggplot() +
  #geom_rect(data = homeo_LL_hal_overlap %>% filter(seqnames == "scaffold_3_RagTag"), aes(xmin = start/1e5, xmax = end/1e5, ymin = 0, ymax = 25), alpha = 0.5) +
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_3_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[3]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_3_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[3]), y = coverage, color = sample)) +
  xlab("Chromosome 3") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr4 <- ggplot() +
  ...
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_4_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[4]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_4_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[4]), y = coverage, color = sample)) +
  xlab("Chromosome 4") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr5 <- ggplot() +
  ...
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_5_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[5]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_5_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[5]), y = coverage, color = sample)) +
  xlab("Chromosome 5") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr6 <- ggplot() +
  geom_rect(data = nonhomeo_LL_overlap_continuous %>% filter(start_scaffold == "scaffold_6_RagTag"), aes(xmin = start_coordinate/1e5, xmax = end_coordinate/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "chartreuse4") +
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_6_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[6]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_6_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[6]), y = coverage, color = sample)) +
  xlab("Chromosome 6") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr7 <- ggplot() +
  ...
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_7_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[7]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_7_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[7]), y = coverage, color = sample)) +
  xlab("Chromosome 7") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
...
LL_both_chr8 <- ggplot() +
  geom_rect(data = nonhomeo_LL_overlap_continuous %>% filter(start_scaffold == "scaffold_8_RagTag"), aes(xmin = start_coordinate/1e5, xmax = end_coordinate/1e5, ymin = 0, ymax = 25), alpha = 0.5, fill = "chartreuse4") +
  geom_line(data = LL_all_hal %>% filter(seqnames == "scaffold_8_RagTag", sample == "LL_RS7K_G4_hal"), aes(x = c(1:chrom_length_hal[8]), y = coverage, color = sample)) +
  geom_line(data = LL_all_lyr %>% filter(seqnames == "scaffold_8_RagTag", sample == "LL_RS7K_G4_lyr"), aes(x = c(1:chrom_length_lyr[8]), y = coverage, color = sample)) +
  xlab("Chromosome 8") +
  theme_linedraw() +
  theme(legend.position = "none") +
  ylim(0,25)
