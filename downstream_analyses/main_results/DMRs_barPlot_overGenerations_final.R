...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vpro1_LL/dmrseq")
dmrseq_output_CG_hal <- fread("CG_context/parent1_v_allo.txt")
dmrseq_output_CHG_hal <- fread("CHG_context/parent1_v_allo.txt")
dmrseq_output_CHH_hal <- fread("CHH_context/parent1_v_allo.txt")
dmrseq_output_CG_lyr <- fread("CG_context/parent2_v_allo.txt")
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vsyn1_LL/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_alk1Vsyn4_LL/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vpro1_LL/dmrseq")
dmrseq_output_CG_hal <- fread("CG_context/parent1_v_allo.txt")
dmrseq_output_CHG_hal <- fread("CHG_context/parent1_v_allo.txt")
dmrseq_output_CHH_hal <- fread("CHH_context/parent1_v_allo.txt")
dmrseq_output_CG_lyr <- fread("CG_context/parent2_v_allo.txt")
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vsyn1_LL/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
setwd("~/OneDrive/PhD/Project/Chapter_3/DMR_results/ARPEGGIO_results_tks1Vsyn4_LL/dmrseq")
dmrseq_output_CG_AvB <- fread("CG_context/A_v_B_polyploid.txt")
dmrseq_output_CHG_AvB <- fread("CHG_context/A_v_B_polyploid.txt")
dmrseq_output_CHH_AvB <- fread("CHH_context/A_v_B_polyploid.txt")
...
# We repeat the analyses of the first part but with another dataset
...
hm_conditions <- ggplot(dmrs_context_total, aes(x=factor(interaction(context, comparison), levels = c("CG.G1",
                                                                                     "CG.G4",
                                                                                     "CHG.G1",
                                                                                     "CHG.G4",
                                                                                     "CHH.G1",
                                                                                     "CHH.G4")), y=value, fill = comparison, col = factor(hypo_hyper, levels = c("hyper", "hypo")))) +
...
ll_conditions <- ggplot(dmrs_context_total, aes(x=factor(interaction(context, comparison), levels = c("CG.G1",
                                                                                                      "CG.G4",
                                                                                                      "CHG.G1",
                                                                                                      "CHG.G4",
                                                                                                      "CHH.G1",
